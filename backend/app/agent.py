...
class ConfigurableChatBot(RunnableBinding):
    ...
    def __init__(
        self,
        *,
        llm: LLMType = LLMType.AZURE_OPENAI,
        system_message: str = DEFAULT_SYSTEM_MESSAGE,
        kwargs: Optional[Mapping[str, Any]] = None,
        config: Optional[Mapping[str, Any]] = None,
        **others: Any,
...
chatbot = (
    ConfigurableChatBot(llm=LLMType.AZURE_OPENAI, checkpoint=RedisCheckpoint())
    .configurable_fields(
...
class ConfigurableRetrieval(RunnableBinding):
    ...
    def __init__(
        self,
        *,
        llm_type: LLMType = LLMType.AZURE_OPENAI,
        system_message: str = DEFAULT_SYSTEM_MESSAGE,
        assistant_id: Optional[str] = None,
        kwargs: Optional[Mapping[str, Any]] = None,
        config: Optional[Mapping[str, Any]] = None,
...
chat_retrieval = (
    ConfigurableRetrieval(llm_type=LLMType.AZURE_OPENAI, checkpoint=RedisCheckpoint())
    .configurable_fields(
